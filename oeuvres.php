...
$oeuvres = [
    ...
    [
        'id' => 5,
        'title' => 'Le Souffle du Désert',
        'description' => 'Une œuvre captivante de Jayden Simmer qui utilise des textures et des couleurs pour représenter l\'essence du désert. Cette peinture évoque les vastes étendues désertiques baignées de lumière et de chaleur, rendues avec une technique mixte qui donne vie à chaque détail.',
        'author' => 'Jayden Simmer',
        'img' => 'steve-johnson-2.png'
    ],

    [
        'id' => 6,
        'title' => 'Caresse de l\'Aurore',
        'description' => 'Lyla Rennt capture le moment magique où les premiers rayons du soleil caressent la terre. Avec une palette de couleurs douces, cette œuvre inspire un sentiment de paix et d\'émerveillement face à la beauté de la nature.',
        'author' => 'Lyla Rennt',
    ...
    [
        'id' => 7,
        'title' => 'Echos Urbains',
        'description' => 'Rémi Tailored nous plonge dans l\'ambiance vibrante de la ville avec "Echos Urbains". À travers une composition dynamique et un choix de couleurs vives, cette œuvre traduit l\'énergie et le mouvement incessant de la vie urbaine.',
        'author' => 'Rémi Tailored',
    ...
    [
        ...
        'description' => 'Harmonie en Bleu, par Elise Corner, est une exploration de la couleur bleue sous toutes ses nuances. À travers une approche minimaliste, l\'artiste invite à la réflexion et à l\'apaisement, faisant de cette œuvre un havre de tranquillité.',
        'author' => 'Elise Corner',
    ...
    [
        'id' => 9,
        'title' => 'Vortex Chromatique',
        'description' => 'Alex Verner crée un tourbillon de couleurs avec "Vortex Chromatique". Cette œuvre abstraite est un véritable spectacle visuel, où chaque coup de pinceau contribue à une composition à la fois chaotique et harmonieuse.',
        'author' => 'Alex Verner',
    ...
    [
        'id' => 10,
        'title' => 'Murmures Sylvestres',
        'description' => 'Dans "Murmures Sylvestres", Nora Field invite à écouter les subtiles voix de la forêt. Avec un réalisme saisissant et une attention particulière portée aux détails, cette œuvre célèbre la beauté et la sérénité de la nature sauvage.',
        'author' => 'Nora Field',
        'img' => 'sincerely-media.png'
    ],
